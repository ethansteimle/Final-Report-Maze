...

{
    ...
    while (1)
    {
        ...
        case SETUP_TURN90:
                ...
                case TURN90_1:
                    left_done = (left_encoder_zero_pos - get_left_motor_count()) > TURN_TARGET_TICKS_90;
                    right_done = (right_encoder_zero_pos - get_right_motor_count()) < -TURN_TARGET_TICKS_90;
